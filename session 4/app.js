...
// //questions:
// //4.1 What does x receives from product, property or value?
// // x nhận được property ( name, price, brand, color);
// //4.2 Use the for loop to print/log out the following output
// for (let x in product) {
//     console.log(x + ` ${product[x]}`);
// }

//5.
//Then use one line of code to destructure to obtain subject,
//dueDate and assignTo from this object:
...
//6.What is the data type of the outermost layer (Number, String, Object, Array or else)?
//- Oject

//The hits property is where the job results are stored,
// is it a Number, String, Array, Object or something else?

//- Array

//In each hit of hits, how to find the job’s title,
//locations, salary, benefits, skills and requirements

//7.Write a script to sumulate a clothes shop,
//asking and performing certain tasks from user

// let loop=true;

// const itemShop = ["Jean","T-Shirt","Socks"];
// while(loop){
// const userInput = prompt("Hi there, welcome to shop admin panel, what do you want(C,R,U,D").toLowerCase();
// let stt=0;
// function readItem(){
//     for(let i of itemShop){
//         stt++;
//         console.log(`${stt}.${i}`);
//     }
// }
...
//     itemShop[updateItem-1] = changeName;
//     alert("Done");
//     readItem();

// }else if(userInput==="d"){
//     let deleteItem = Number(prompt("Enter the position you want to delete"));
//     itemShop.splice(deleteItem-1,1);
//     alert("Done");
//     readItem();
// }else if(userInput==="e"){
//     break;
...
// const frontEndDev = ["HTML","CSS","Basics of JavaScript","Node Package Manager (npm)","Git"];
...
// const userInput = prompt("Enter your command (New, Delete, Upgrade, Complete)").toLowerCase();
// if(userInput==="new"){
//     let newTask = prompt("Enter new task: ");
//     frontEndDev.push(newTask);
//     readSkills();

// }else if(userInput==="delete"){

// }else if(userInput==="upgrade"){
//     let updateTask = prompt("Enter position");
//     let updateNewTask = prompt("Enter new title")
//     frontEndDev[updateTask-1] = updateNewTask;
//     readSkills();

// }else if(userInput==="complete"){
    
//     let completeTask = Number(prompt("Enter position"));
//     for(let i = 0 ; i <= frontEndDev.length-1;i++){
//         stt++;
//         if(i === completeTask){
...
// Optional Make Printing / logging better

//Serious exercices

//9
// let num = 0;
// let inputNumber = prompt("Enter a squence of Number, separated by commas (,)");
// let a = inputNumber.split(",");
// console.log(a);
// for(let i of a){
//     num = num + parseInt(i);

// }
// console.log(`The sum of them is ${num}`);
//10

// let inputNumber = prompt("Enter a squence of Number, separated by commas (,)");
// let a = inputNumber.split(",").map(function(item){
...
//     index++;
//     if(inputNumber==i){
//         console.log(`${i} is FOUND in my arr at index ${index}`);
//     }else{
//         console.log(`${inputNumber} is NOT found in my arr`);
//     }
// }

// for(let i = 0; i < numbers.length;i++){
//     if(inputNumber==numbers[i]){
//         console.log(`${numbers[i]} is FOUND in my array at index ${i+1} `);
//     }else{
//         console.log(`${inputNumber} is NOT found in my array`);
//     }
// }
...
//13.
// let colors = ["gray", "blue", "purple", "cyan"];
...
// function squareArt(height,width){
//     repeat(2, function(){
//     forward(height);
//     right(90);
//     forward(width);
...
//     goto(rect.x,rect.y);
//     squareArt(rect.height,rect.width);
//     }
...
// let child = (job.hits)[0];
// console.log(child);
// let b = child.jobTitle;
// console.log(`First job title 
// ${b}`);
// let c = child.benefits;
// console.log(c);
// let d = c.forEach(element => {
//     console.log(element.benefitValue);
// });
